...
public class TaskExecutionServiceImpl implements ITaskExecutionService {
	...
	@Override
	public List<TaskExecution> getAllTaskExecution(int page, int size) {

		log.warn("Loading all taskExecution ! be careful about performance");
		
		return (List<TaskExecution>) this.taskExecutionRepository.findPageTaskExecution(new PageRequest(page, size));
	}
